...
/**
 * Logistic regression baseline train/test for any type of data, but for one of the tasks.
 * 
 * @author sorinMD
 *
 */
public class CatanLogisticRegression {
	private static Logger log = LoggerFactory.getLogger(CatanLogisticRegression.class);
...
//            for(int idx = p.size(1) - 1000 ; idx < p.size(1); idx++){
//            	System.out.print(String.format( "%.2f", p.getDouble(idx)));
//            	if(idx%100 == 0)
//            		System.out.println();
//            }
